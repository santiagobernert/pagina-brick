...
<section id="contacto" class="parallax">
	<div id="contenedor">
		...
		<form id="formulario" action="" method="POST">
			<div class="izq">
				<input type="text" name="nombre" id="nombre" placeholder="Name and last name" required>
				<input type="email" name="direccion-mail" id="correoelec" placeholder="Email" required>
			</div>
			<div class="der">
				<textarea name="mensaje" id="mensaje" required>Message</textarea>
			</div>
			<input type="submit" name="submit-form" id="enviar" value="SEND">
		</form>
		<?php 
		if(isset($_POST['submit-form'])){
		    ...
		    echo "<h5>Thank you for the message " . $first_name . ", we will contact you soon.</h5>";
